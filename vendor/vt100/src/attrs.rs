...
/// How text is underlined, from `SGR 4:n`.
#[derive(Eq, PartialEq, Debug, Copy, Clone, Default)]
pub enum UnderlineStyle {
    ...
    /// `SGR 21` or `4:2`.
    Double,
    /// `SGR 4:3`, the undercurl editors mark diagnostics with.
    Curly,
    /// `SGR 4:4`.
    Dotted,
    /// `SGR 4:5`.
...
impl Attrs {
    ...
    pub fn underline(&self) -> bool {
        self.ulstyle != UnderlineStyle::None
    }

    pub fn set_underline(&mut self, underline: bool) {
        self.ulstyle = if underline {
    ...
    pub fn blink(&self) -> bool {
        self.flag(TEXT_MODE_BLINK)
    }

    pub fn set_blink(&mut self, on: bool) {
        self.set_flag(TEXT_MODE_BLINK, on);
    }

    pub fn hidden(&self) -> bool {
        self.flag(TEXT_MODE_HIDDEN)
    }

    pub fn set_hidden(&mut self, on: bool) {
        self.set_flag(TEXT_MODE_HIDDEN, on);
    }

    pub fn strikethrough(&self) -> bool {
        self.flag(TEXT_MODE_STRIKETHROUGH)
    }

    pub fn set_strikethrough(&mut self, on: bool) {
        self.set_flag(TEXT_MODE_STRIKETHROUGH, on);
    }
